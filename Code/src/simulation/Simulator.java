...
public class Simulator implements WorldListener {
	...
	public Simulator(SOSListener l) throws Exception {
		emergencyService = l;
		//updateService =(UpdateListener) l;
	...
	public void nextCycle() throws CitizenAlreadyDeadException, BuildingAlreadyCollapsedException, CannotTreatException, IncompatibleTargetException {
		...
		((UpdateListener) emergencyService).update(currentCycle);
	...
	public void updates() {
		updateService.update(currentCycle);
	}
